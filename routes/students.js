...
const {CreateStudent,updateStudentprofile,deleteStudent,StudentProfile,getStudents,getstudentcount, getStudentslist}=require("../controllers/students")
...
route.get(routesname.studentlist,authenticate,getStudentslist)
